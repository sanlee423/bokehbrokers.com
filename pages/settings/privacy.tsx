  ...
  return (
    <div className={classes.pageContainer}>
      ...
      <Typography variant="body2">
        ...
        improve our products and services. Here are the types of personal
      ...
      <ul className={classes.bulletList}>
        <li>
          <Typography variant="body2">
            ...
            provide. You can choose not to provide certain information, but then
            you might not be able to take advantage of many of our services.
          </Typography>
        </li>
        <li>
          <Typography variant="body2">
            • Automatic Information: We automatically collect and store certain
            types of information about your use of Campedia, including
            ...
            information when your web browser or device accesses Campedia
