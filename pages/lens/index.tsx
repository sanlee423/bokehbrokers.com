...
import LensInfiniteHits from '@/components/hitLens/LensInfiniteHits';

const ALGOLIA_LENS_INDEX = process.env.ALGOLIA_LENS_INDEX;
              ...
              <div className={classes.mobileFilterContainer}>
                ...
                <SwipeableDrawer
                  ...
                  <StyledBox
                    ...
                    <div className={classes.mobileFilterBy}>
                      <Typography>Filter Thread</Typography>
                      <RefinementList
                        attribute={'Filter Thread'}
                        transformItems={(
                          items: Array<RefinementItem<string>>,
                        ) => orderBy(items, 'label', 'asc')}
                      />
                    ...
                    <div className={classes.mobileFilterBy}>
                      <Typography>Lens Features</Typography>
                      <RefinementList
                        attribute={'Lens Features'}
                        transformItems={(
                          items: Array<RefinementItem<string>>,
                        ) => orderBy(items, 'label', 'asc')}
                      />
                    ...
                    <div className={classes.mobileFilterBy}>
                      <Typography>Lens Mount</Typography>
                      <RefinementList
                        attribute={'Lens Mount'}
                        transformItems={(
                          items: Array<RefinementItem<string>>,
                        ) => orderBy(items, 'label', 'asc')}
                      />
