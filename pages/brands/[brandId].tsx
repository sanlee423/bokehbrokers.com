  ...
  return (
    <div className={classes.homeContainer}>
        <div className={classes.brandSection}>
            <br />
            <Typography className={classes.brandHeading} variant="h4">Leica</Typography>
            <Typography>Leica Camera AG (/ˈlaɪkʌ/) is a German company that manufactures cameras, optical lenses, photographic lenses, binoculars, rifle scopes and microscopes. The company was founded by Ernst Leitz in 1869 (Ernst Leitz Wetzlar), in Wetzlar, Germany.
