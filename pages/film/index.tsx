...
import FilmInfiniteHits from '@/components/hitFilm/FilmInfiniteHits';

const ALGOLIA_FILM_INDEX = process.env.ALGOLIA_FILM_INDEX;
              ...
              <div className={classes.mobileFilterContainer}>
                ...
                <SwipeableDrawer
                  ...
                  <StyledBox
                    ...
                    <div className={classes.mobileFilterBy}>
                      <Typography>Film Formats</Typography>
                      <RefinementList
                        attribute={'Film Formats'}
                        transformItems={(
                          items: Array<RefinementItem<string>>,
                        ) => orderBy(items, 'label', 'asc')}
                      />
                    ...
                    <div className={classes.mobileFilterBy}>
                      <Typography>Film Processing</Typography>
                      <RefinementList
                        attribute={'Film Processing'}
                        transformItems={(
                          items: Array<RefinementItem<string>>,
                        ) => orderBy(items, 'label', 'asc')}
                      />
                    ...
                    <div className={classes.mobileFilterBy}>
                      <Typography>Film Speed</Typography>
                      <RefinementList
                        attribute={'Film Speed'}
                        transformItems={(
                          items: Array<RefinementItem<string>>,
                        ) => orderBy(items, 'label', 'asc')}
                      />
                    ...
                    <div className={classes.mobileFilterBy}>
                      <Typography>Film Type</Typography>
                      <RefinementList
                        attribute={'Film Type'}
                        transformItems={(
                          items: Array<RefinementItem<string>>,
